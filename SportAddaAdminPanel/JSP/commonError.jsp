...
<link href="../css/hisupport.css" rel="stylesheet" type="text/css">
<!-- InstanceEndEditable -->
        ...
        <td colspan="2"><table width="975" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>            
			...
			<html:form action="/login">			
				<table width="100%">
					<tr>
					  <td class="pagetitle" >Under Construction !  </td>
					  </tr>
					<tr>
					...
					<tr>
					  <td align="center" valign="middle"  class="opmsg">Sorry For Inconvenience <br> 
