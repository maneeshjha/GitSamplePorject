...
<script language="JavaScript" src="<%=request.getContextPath()%>/js/ChangePassword.js"></script>
<script language="javascript" src="<%=request.getContextPath()%>/js/common.js"></script>
<%
	String  saveResult	=	(String)request.getAttribute("saveResult");
	String	msgType		=	(String)request.getAttribute("msgType");
%>	
<html:form action="/utilityAction" focus="oldPassword">
<input type="hidden" name="reqCode"/>

	<table width="100%" border="0" cellspacing="1" cellpadding="1">
		<tr>
        	<td align="left" valign="middle" class="pagetitle">Change Password</td>
      	</tr>		
		<tr>
	 ...
	 <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
		<tr>
            <td width="18%" align="left" valign="top" class="normaltext">Old Password</td>
            <td width="2%" align="center" valign="middle" class="mandatory">*</td>
            <td width="80%" align="left" valign="top">
			<html:password property="oldPassword" onkeypress="return checkenter(event);" styleClass="textbox"  maxlength="98"/></td>
          </tr>	
          <tr>
            <td width="18%" align="left" valign="top" class="normaltext">New Password</td>
            <td align="center" valign="middle" class="mandatory">*</td>
            <td width="80%" align="left" valign="top" >
			<html:password property="newPassword" maxlength="98" styleClass="textbox" onkeypress="return checkenter(event)"/>
			</td>
          </tr>
		  <tr>
            <td width="18%" align="left" valign="top" class="normaltext">Confirm Password</td>
            <td align="center" valign="middle" class="mandatory">*</td>
            <td width="80%" align="left" valign="top" >
			<html:password property="confirmPassword" maxlength="98" styleClass="textbox" onkeypress="return checkenter(event)"/>
			</td>
          </tr>
        </table>		
		</td>
	 ...
	 <tr>
        <td align="left" valign="middle" >
		<input name="btnPassword" type="button" id="btnPassword" class="btn" onClick="return changePassword()" value="Change Password"/>&nbsp;
