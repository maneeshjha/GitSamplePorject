...
<table width="1011" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<tr>
		<td align="left" valign="middle" class="pagetitle">Utility</td>
	</tr>
	<tr>
		<td align="left" valign="middle">&nbsp;	</td>
	</tr>
	...
	<table width="60%" border="0" cellspacing="8" cellpadding="1">
			
			<tr>
            <td align="center" valign="middle"><img src="<%=request.getContextPath()%>/images/bullets.jpg" border="0" alt="" height="10" width="10"/></td>
		    <td align="left" valign="middle"><a href="<%=request.getContextPath()%>/userAction.do?reqCode=showUserMasterList" class="sidemenu">User Master</a></td>
		    </tr>
			<tr>
            <td align="center" valign="middle"><img src="<%=request.getContextPath()%>/images/bullets.jpg" border="0" alt="" height="10" width="10"/></td>
		    <td align="left" valign="middle"><a href="<%=request.getContextPath()%>/roleAction.do?reqCode=showRoleMasterList" class="sidemenu">Role Master</a></td>
		    </tr>
			<tr>
            <td align="center" valign="middle"><img src="<%=request.getContextPath()%>/images/bullets.jpg" border="0" alt="" height="10" width="10"/></td>
		    <td align="left" valign="middle"><a href="<%=request.getContextPath()%>/utilityAction.do?reqCode=showChangePasswordPage" class="sidemenu">Change Password </a></td>
		    </tr>
			<tr>
            <td align="center" valign="middle"><img src="<%=request.getContextPath()%>/images/bullets.jpg" border="0" alt="" height="10" width="10"/></td>
		    <td align="left" valign="middle"><a href="<%=request.getContextPath()%>/utilityAction.do?reqCode=showResetPasswordPage" class="sidemenu">Reset Password </a></td>
		    </tr>
	</table>
	</td>
  </tr>
