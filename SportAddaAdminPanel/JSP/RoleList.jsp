...
<html:hidden property="roleId" />	
	...
	<tr>
	  ...
	  <tr>
        <td align="left" valign="middle" class="pagetitle">Role List</td>
      </tr>
	 ...
	 <tr>
	 	<td align="left" valign="middle"><table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tr>
            <td width="18%" align="left" valign="middle" class="normaltext">Role Name</td>
            <td width="2%" align="center" valign="middle">&nbsp;</td>
            <td width="80%" align="left" valign="middle">
			<html:text property="roleName" onkeyup="return getRoleNameList(this,event);" onkeypress="return checkenter(event);" styleClass="textbox"  />
				<div class="mandatory" id="msgTTS">Type to Search</div>						
				<div id="divRoleName" class="ajaxDiv"></div>
			</td>
          </tr>
		  <tr>
	  ...
	  <tr>
        <td align="left" valign="middle">          
          ...
          <input name="btnClear" type="button" id="btnClear" class="btn"  value="Clear" onClick="return clearRoleListForm()"/>&nbsp;
          <input name="btnAddNew" type="button" id="btnAddNew" class="btn"  value="Add New" onClick="return addNewRole()"/>            
		</td>         
      </tr>
	 ...
	 <tr>
		...
		<logic:notEmpty name="reqSearchList">
		<logic:present name="reqSearchList">
		<display:table style="width:100%;" id="list" name="requestScope.reqSearchList"  requestURI="/roleAction.do" pagesize="20" summary="Role Master List" class="dtable"  export="false">
		
			<bean:define name="list" type="java.lang.String" property="field2" id="roleId"/>
			<bean:define name="list" type="java.lang.String" property="field3" id="roleName"/>
			
	
			<display:column title="#" property="field1" style="width:5%;"/>
			<display:column title="Role Name" property="field3" />
			<display:column title="Description" property="field4" />
			<display:column title="Status" property="field5"/>
			
			<display:column title="Modify" style="width:5%;" >
			<center>
			<a href="javascript:modifyRoleName('<%=roleId%>')">
