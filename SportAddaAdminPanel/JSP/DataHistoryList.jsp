...
<html:form action="/syncAction" >
	...
	<tr>
	  ...
	  <tr>
        <td align="left" valign="middle" class="pagetitle">Data History List</td>
      </tr>
	 ...
	 <tr>
		...
		<logic:notEmpty name="reqHistoryDataList">
		<logic:present name="reqHistoryDataList">
		<display:table style="width:100%;" id="list" name="requestScope.reqHistoryDataList"  requestURI="/syncAction.do" pagesize="20" summary="Data History List" class="dtable"  export="false">
		
			<display:column property="field1"  title="#" style="align:center;width:3%;"  />			
			<display:column property="field2"  title="Data Taken On" />			
			<display:column property="field3"  title="Data Taken By" />
			<display:column property="field4"  title="No Of Records"/>
			<display:column property="field5"  title="Product Count"/>
			<display:column property="field6"  title="Pricing Count"/>
			<display:column property="field7"  title="Barcode Count"/>
			
			<display:setProperty name="export.excel.filename" value="DataHistoryList.xls"/>
			<display:setProperty name="export.pdf.filename" value="DataHistoryList.pdf"/>
