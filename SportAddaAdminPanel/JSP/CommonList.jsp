...
<script language="JavaScript" src="<%=request.getContextPath()%>/js/CommonMaster.js"></script>
...
<input type="hidden" name="group_Value_id"/>
<input type="hidden" name="group_value_name" />
...
<html:hidden property="groupName" />
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
		<tr>
        	<td align="left" valign="middle" class="pagetitle">Common List</td>
      	</tr>
		<tr>
	 ...
	 <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tr>
            <td width="18%" align="left" valign="middle" class="normaltext">Group Name</td>
            <td width="2%" align="center" valign="middle">&nbsp;</td>
            <td width="80%" align="left" valign="middle">
				<div id="divGroupName">
				<html:select  property="groupId" style="width:auto;" styleClass="list">
		  ...
		  <tr style="display:none;">
            <td width="18%" align="left" valign="middle" class="normaltext">Group Value</td>
            <td width="2%" align="center" valign="middle">&nbsp;</td>
            <td width="80%" align="left" valign="middle">
				<html:text property="groupValue" onkeyup="return getGroupValueList(this,event);" onkeypress="return checkenter(event);" styleClass="textbox"  />
				<div class="mandatory" id="msgTTS">Type to Search</div>						
				<div id="divGroupValue" class="ajaxDiv"></div>
			</td>
          </tr>
		  <tr>
	 ...
	 <tr>
        <td align="left" valign="middle">          
          <input name="btnSearch" type="button" id="btnSearch" class="btn" onClick="return getSeacrhList()" value="Search"/>&nbsp;
          <input name="btnClear" type="button" id="btnClear" class="btn" onClick="return clearCommonListForm()" value="Clear"/>&nbsp;
         <input name="btnAddNew" type="button" id="btnAddNew" class="btn" onClick="return addNewCommonMaster()" value="Add New"/>           
		</td>         
      </tr>
...
<tr>
		...
		<logic:notEmpty name="reqGroupValueMasterList">
		<logic:present name="reqGroupValueMasterList">
		
		<div style="width:950px;overflow-x:auto;overflow-y:hidden);">
		
		<display:table id="clist" name="requestScope.reqGroupValueMasterList" requestURI="/commonMasterAction.do" class="dtable" summary="Group Value List" pagesize="20" style="width:100%">
		
		<bean:define name="clist" type="java.lang.String" property="field2" id="groupValueId"/>
		<bean:define name="clist" type="java.lang.String" property="field4" id="groupValueName"/>
		<bean:define name="clist" type="java.lang.String" property="field8" id="allowModify"/>
		
		<display:column title="#" property="field1" style="width:5%;"/>
		<display:column title="Group Name" property="field5" />
		<display:column title="Group Value" property="field4"/>
		
		<display:column title="Description" property="field6" style="width:35%"/>
		<display:column title="Status" property="field7" />
		
		
		<display:column title="Modify" style="width:5%;" >
		
		<% if(allowModify != null && allowModify.length() >0 && allowModify.equals("Y")) { %>
			<center>
			<a href="javascript:modifyGroupValue('<%=groupValueId%>')">
		...
		<center>
			<a href="javascript:deleteGroupValue('<%=groupValueId%>','<%=groupValueName%>')">
