...
<title>ComplianceKey Admin Panel</title>
<!-- InstanceEndEditable -->
...
<table width="1011" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<tr>
		<td align="left" valign="middle" class="pagetitle">Masters</td>
	</tr>
	<tr>
		<td align="left" valign="middle">&nbsp;	</td>
	</tr>
	...
	<table width="60%" border="0" cellspacing="8" cellpadding="1" >
		    ...
		    <td align="left" valign="middle"><a href="<%=request.getContextPath()%>/commonMasterAction.do?reqCode=showCommonMasterList" class="sidemenu">Common Master</a></td>
		    </tr>
	</table>
	</td>
  </tr>
