...
<html:form action="/certificateAction" enctype="multipart/form-data" focus="customer_name" >
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" >
	<tr>
	  ...
	  <tr>
        <td align="left" valign="middle" class="pagetitle">Add Certificate </td>
      </tr>
	 ...
	 <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tr valign="top">
            <td width="18%" align="left" class="normaltext">Name</td>
            <td width="2%" align="left" class="mandatory">*</td>
            <td width="80%" align="left">
			<html:text property="customer_name" maxlength="98" styleClass="textbox" onkeypress="return checkenter(event)"/></td>
          </tr>
		  
		 
		  <tr valign="top" id = "trPassword">
            <td width="18%" align="left" class="normaltext">Certificate</td>
            <td width="2%" align="left" class="mandatory">*</td>
            <td width="80%" align="left">
			<html:textarea property="testimonials" styleClass="textarea" onkeypress="return checkenter(event)"/></td>
          </tr> 
	  <tr>
	    <td align="left" valign="middle" ></td>
	    </tr>	  
	  <tr>
		<td align="left" valign="middle" >
			<input name="btnSave" type="button" id="btnSave" class="btn"  value="Save" onClick="return saveCertificateMaster()"/>&nbsp;
			 </td>
	  </tr>
    </table>			
</html:form>
